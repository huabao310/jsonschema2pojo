...
public interface GenerationConfig {
   ...
   *         {@link Long}) instead of <code>int</code> (or
   *         {@link Integer}) when representing the JSON Schema type
   *         'integer'.
   */
   ...
   *         of <code>int</code> (or {@link Integer}) when
   ...
   *         {@link Double}) instead of <code>float</code> (or
   *         {@link Float}) when representing the JSON Schema type
   *         'number'.
   */
   ...
   *         of <code>float</code> (or {@link Float}) when
  ...
  /**
   * Whether to mark generated classes with the annotation <code>com.fasterxml.jackson.annotation.JsonIgnoreProperties</code>
   */
  boolean isIncludeJsonIgnorePropertiesAnnotation();

  boolean isIncludeLombok();
