...
import static org.huabao.jsonschema2pojo.rules.PrimitiveTypes.*;
...
import org.huabao.jsonschema2pojo.model.EnumDefinition;
import org.huabao.jsonschema2pojo.util.AnnotationHelper;
import org.huabao.jsonschema2pojo.util.TypeUtil;
import org.huabao.jsonschema2pojo.Annotator;
import org.huabao.jsonschema2pojo.RuleLogger;
import org.huabao.jsonschema2pojo.Schema;
import org.huabao.jsonschema2pojo.exception.ClassAlreadyExistsException;
import org.huabao.jsonschema2pojo.model.EnumDefinitionExtensionType;
import org.huabao.jsonschema2pojo.model.EnumValueDefinition;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import org.huabao.codemodel.ClassType;
import org.huabao.codemodel.JBlock;
import org.huabao.codemodel.JClass;
import org.huabao.codemodel.JClassAlreadyExistsException;
import org.huabao.codemodel.JClassContainer;
import org.huabao.codemodel.JConditional;
import org.huabao.codemodel.JDefinedClass;
import org.huabao.codemodel.JEnumConstant;
import org.huabao.codemodel.JExpr;
import org.huabao.codemodel.JExpression;
import org.huabao.codemodel.JFieldVar;
import org.huabao.codemodel.JForEach;
import org.huabao.codemodel.JInvocation;
import org.huabao.codemodel.JMethod;
import org.huabao.codemodel.JMod;
import org.huabao.codemodel.JType;
import org.huabao.codemodel.JVar;
...
public class EnumRule implements Rule<JClassContainer, JType> {
    ...
    public JType apply(String nodeName, JsonNode node, JsonNode parent, JClassContainer container, Schema schema) {
        ...
        if(ruleFactory.getGenerationConfig() != null && ruleFactory.getGenerationConfig().isIncludeGeneratedAnnotation()) {
            AnnotationHelper.addGeneratedAnnotation(_enum, AnnotationHelper.JAVA_8_GENERATED, "value", AnnotationHelper.GENERATOR_NAME);
        }
